  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 h-screen p-6 dark:bg-slate-900 dark:border-slate-800 transition-colors">
      ...
      <nav className="flex flex-col gap-2 flex-1 overflow-y-auto">
        ...
        {/* Lista de Compras mostra fornecedores, então escondemos do caixa também, ou deixamos opcional */}
        {isAdmin && (
        ...
        {/* Financeiro geralmente é sensível, mas se quiser liberar, tire o check isAdmin */}
        {isAdmin && (
